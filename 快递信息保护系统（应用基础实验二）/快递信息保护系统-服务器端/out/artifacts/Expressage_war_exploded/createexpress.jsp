...
%>
	...
	<!--下面是右边导航栏的代码-->
	<div id="round">
	<form action="addexpress.jsp" method="post" id="form">
    <div id="express_form">
        <div class="input_control">
        	寄件人：
        	<input class="text_value" value="" name="express_sendman" type="text" id="express_sendman">
        </div>
		<div class="input_control">
			寄件人联系方式：
			<input class="text_value" value="" name="express_phone_sendman" type="text" id="express_phone_sendman">
		</div>
        <div class="input_control">
        	收件人：
        	<input class="text_value" value="" name="express_receiver" type="text" id="express_receiver">
        </div>
        <div class="input_control">
        	收件人联系方式:
        	<input class="text_value" value="" name="express_phone" type="text" id="express_phone">
        </div>
        <div class="input_control">
        	联系地址:
        	<input class="text_value" value="" name="express_address" type="text" id="express_address">
        </div>
		<div class="input_control">
			快递员：
		...
		<div style="text-align:right">
			<button class="button" id="submit" type="submit">添加</button><br>
		</div>
		<div style="text-align:right">
                    快递单的状态:<%=session.getAttribute("addexpress")%>
			</div>
